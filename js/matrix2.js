...
var poblacion = L.tileLayer.wms("http://92.57.156.127:8080/geoserver/matrix/wms?", {
...
var densidad = L.tileLayer.wms("http://92.57.156.127:8080/geoserver/matrix/wms?", {
        layers: 'Variables_Demograficas',
...
var nacimientos = L.tileLayer.wms("http://92.57.156.127:8080/geoserver/matrix/wms?", {
        layers: 'Variables_Demograficas',
...
var defunciones = L.tileLayer.wms("http://92.57.156.127:8080/geoserver/matrix/wms?", {
        layers: 'Variables_Demograficas',
...
div.innerHTML +=
'<img alt="Legend" src="http://92.57.156.127:8080/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=20&HEIGHT=20&LAYER=matrix:Variables_Demograficas" width="4" height="4" />';
...
div.innerHTML +=
'<img alt="Legend" src="http://92.57.156.127:8080/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=20&HEIGHT=20&LAYER=matrix:Variables_Demograficas&style=matrix:poblacion_estilo" width="160" height="220" />';
...
div.innerHTML +=
'<img alt="Legend" src="http://92.57.156.127:8080/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=20&HEIGHT=20&LAYER=matrix:Variables_Demograficas&style=matrix:densidad_estilo" width="160" height="200" />';
...
div.innerHTML +=
'<img alt="Legend" src="http://92.57.156.127:8080/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=20&HEIGHT=20&LAYER=matrix:Variables_Demograficas&style=matrix:nacimiento_estilo" width="160" height="200" />';
...
div.innerHTML +=
'<img alt="Legend" src="http://92.57.156.127:8080/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=20&HEIGHT=20&LAYER=matrix:Variables_Demograficas&style=matrix:defunciones_estilo" width="160" height="200" />';
...
div.innerHTML +=
'<img alt="Imagen" src="imagen.png" width="160" height="115" />';
